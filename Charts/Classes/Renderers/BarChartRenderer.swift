            ...
            for dataSetIndex in minDataSetIndex..<maxDataSetIndex
            {
                ...
                if (CGFloat(index) < (CGFloat(dataProvider.chartXMax) * animator.phaseX) / CGFloat(setCount))
                {
                    ...
                    if (drawHighlightArrowEnabled)
                    {
                        ...
                        let dividend = abs(pixelToValueMatrix.b * pixelToValueMatrix.b + pixelToValueMatrix.d * pixelToValueMatrix.d)
                        let divisor = sqrt(pixelToValueMatrix.a * pixelToValueMatrix.a + pixelToValueMatrix.c * pixelToValueMatrix.c)
                        
                        let xToYRel = dividend / divisor
